...
export default function Home() {
  ...
  return (
    <div className="container d-flex flex-column justify-content-center align-items-center min-vh-100 text-center p-3">
      <h1 className="mb-5">Wpływ wydajności interfejsu użytkownika na UX</h1>
      <p className="mb-4 text-justify">
        Nazywam się Julia Klechammer i jestem studentą informatyki na Politechnice Poznańskiej.<br />
